...
#         dest = self.operation_copy_dest
    ...
    def __merge_to_center_thread(self):
        ...
        if item is not None:
            ...
            pass
            # FIXME: this is not defined anywhere anymore.  Is it
            # vestigial code?  Leaving it here until I figure out
            # what's going on.
    ...
    #
    #
    # FIXME: this was calling __merge_item(), which no longer exits.
    # Is this vestigial code?
